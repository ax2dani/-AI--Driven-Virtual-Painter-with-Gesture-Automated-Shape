...
while train and cntr != n:
    ...
    cv2.putText(frame, f'Press "s" to save gesture "{gesturenames[cntr]}"', (15, 50), cv2.FONT_HERSHEY_SIMPLEX, 1,
                (255, 255, 255), 2)
    ...
    if time.time() - starttime <= 1:
        cv2.putText(frame, f'Gesture saved succesfully', (width // 2 - 400, height // 2), cv2.FONT_HERSHEY_SIMPLEX, 2,
                    (10, 250, 10), 2)
